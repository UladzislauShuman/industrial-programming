package org.ShumanVlad.program.drawing.tools.colors;

import org.ShumanVlad.program.drawing.tools.colors.elements.ColorButton;
...
public class ColorPanel extends JPanel
{
    ...
    {
        super();
        blackButton = new ColorButton(subscriber,Color.BLACK);
        this.add(this.blackButton);
        redButton = new ColorButton(subscriber,Color.RED);
        this.add(this.redButton);
        blueButton = new ColorButton(subscriber,Color.BLUE);
